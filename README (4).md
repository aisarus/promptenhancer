...
**AI-powered prompt enhancement using multi-stage optimization pipeline**

Transform your basic prompts into professional, structured instructions using advanced AI techniques including Smart Queue analysis, Proposer-Critic-Verifier loop, and Diversification/Stabilization cycles.
...
1. **Smart Queue** - Quality analysis (clarity, structure, constraints)
2. **Proposer** - Rewrites prompt with better structure
3. **Critic** - Identifies issues and suggests improvements
4. **Verifier** - Creates final polished version
5. **D/S Iterations** - Expands and stabilizes (1-6 cycles)
6. **Evaluation** - Compares original vs optimized
...
**Detailed deployment guide:** See [DEPLOY_RAILWAY_FOR_DUMMIES.md](DEPLOY_RAILWAY_FOR_DUMMIES.md)
...
2. Select your LLM backend (Gemini or Grok)
3. Enter your API key (stored securely in browser)
4. Paste your prompt
5. Click "Optimize Prompt"
6. Watch real-time progress as each stage completes
7. Copy your optimized prompt!
...
- Powered by [Google Gemini](https://ai.google.dev/) and [xAI Grok](https://x.ai/)
...
- **Deployment Guide:** [Railway deployment](DEPLOY_RAILWAY_FOR_DUMMIES.md)
- **Issues:** [GitHub Issues](https://github.com/aisarus/promptenhancer/issues)
- **Changelog:** [Version history](CHANGELOG_v2.md)
